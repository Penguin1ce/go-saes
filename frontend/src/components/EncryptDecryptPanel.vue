    ...
    <template #header>
      <div class="card-header">
        <div class="card-title">
          <span>操作面板</span>
          <el-tag size="small" type="success" effect="light">16 位二进制 / Base64</el-tag>
        </div>
        <p class="card-subtitle">
          支持 16 位二进制与 Base64 字符串的加解密操作
        </p>
      </div>
    </template>
          ...
          <el-form ref="encryptBinaryFormRef" :model="encryptBinaryForm" :rules="binaryFormRules" label-position="top"
            ...
            <div class="form-row">
              ...
              <el-form-item label="密钥（16 位二进制或十六进制）" prop="key">
                <el-input v-model="encryptBinaryForm.key" maxlength="18"
                  show-word-limit />
              </el-form-item>
            </div>
            <el-form-item>
          ...
          <el-form ref="encryptHexFormRef" :model="encryptHexForm" :rules="hexFormRules" label-position="top"
            ...
            <div class="form-row">
              ...
              <el-form-item label="密钥（16 位十六进制）" prop="key">
                <el-input v-model="encryptHexForm.key" maxlength="6" show-word-limit />
              </el-form-item>
            </div>
            <el-form-item>
        ...
        <template v-else>
          <el-form ref="encryptBase64FormRef" :model="encryptBase64Form" :rules="asciiFormRules" label-position="top"
            ...
            <div class="form-row">
              ...
              <el-form-item label="密钥（16 位二进制或十六进制）" prop="key">
                <el-input v-model="encryptBase64Form.key" maxlength="18"
                  show-word-limit />
              </el-form-item>
            </div>
            <el-form-item>
        ...
        <template v-if="decryptMode === 'binary'">
          <el-form ref="decryptBinaryFormRef" :model="decryptBinaryForm" :rules="binaryFormRules" label-position="top"
            ...
            <div class="form-row">
              ...
              <el-form-item label="密钥（16 位二进制或十六进制）" prop="key">
                <el-input v-model="decryptBinaryForm.key" maxlength="18"
                  show-word-limit />
              </el-form-item>
            </div>
            <el-form-item>
        ...
        <template v-else-if="decryptMode === 'hex'">
          <el-form ref="decryptHexFormRef" :model="decryptHexForm" :rules="cipherHexFormRules" label-position="top"
            ...
            <div class="form-row">
              ...
              <el-form-item label="密钥（16 位十六进制）" prop="key">
                <el-input v-model="decryptHexForm.key" maxlength="6" show-word-limit />
              </el-form-item>
            </div>
            <el-form-item>
        ...
        <template v-else>
          <el-form ref="decryptBase64FormRef" :model="decryptBase64Form" :rules="base64FormRules" label-position="top"
            ...
            <div class="form-row">
              ...
              <el-form-item label="密钥（16 位二进制或十六进制）" prop="key">
                <el-input v-model="decryptBase64Form.key" maxlength="18"
                  show-word-limit />
              </el-form-item>
            </div>
            <el-form-item>
